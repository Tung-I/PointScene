...
from libs.pointnet_lib.pointnet_module import PointNetSetAbstraction,PointNetFeaturePropogation,FlowEmbedding,PointNetSetUpConv



class FlowNet3DSelf(BaseNet):
    def __init__(self):
        super(FlowNet3DSelf,self).__init__()
    ...
    def forward(self, pc1, pc2, feature1, feature2):
        ...
        return {'flow': flow, 'pc1_warped': pc1_warped}
